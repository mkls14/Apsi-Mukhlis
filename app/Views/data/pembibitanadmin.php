...
<?= $this->section('page-content'); ?>
                ...
                <div class="row" >
                    ...
                    <a type="button" class="btn btn-secondary mb-3 mt-2"  data-toggle="modal" data-target="#bibitModal">Tambah Data</a>
                        ...
                        <table id="userlist" class="table table-hover" >
                            ...
                            <tbody>
                                ...
                                <th scope="row"><?= $i; ?></th>
                                    ...
                                    <td><?= $p->Total; ?></td>
                                    <td> 
                                        <a href="pembibitanAdmin/getpem/<?= $p->id; ?>" class="btn btn-sm btn-success" data-toggle="modal" data-target="#editbibitModal<?= $p->id; ?>">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <a href="pembibitanAdmin/getpem/<?= $p->id; ?>" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#hapusbibitModal<?= $p->id; ?>">
            ...
            <div class="modal fade" id="bibitModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-content">
                        ...
                        <form action="<?php echo base_url('pembibitanAdmin/tambah') ; ?>" method="post">
                            <div class="modal-body">
                                <div class="form-group row">
                                    <label for="tanggal" class="col-sm-3 col-form-label">Tanggal</label>
                                    <div class="col-sm-8 ml-3">
                                    <input type="date" class="form-control" id="tanggal" name="tanggal" placeholder="(yyyy-mm-dd)" required>
                                    </div>
                                </div>
                                <div class="form-group row">
            ...
            <div class="modal fade" id="editbibitModal<?= $p->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="/pembibitanAdmin/ubahpem/<?= $p->id; ?>" method="post">
                                <div class="modal-body">
                                    <div class="form-group row">
                                        <label for="tanggal" class="col-sm-3 col-form-label">Tanggal</label>
                                        <div class="col-sm-8 ml-3">
                                    ...
                                    <div class="form-group row">
                                        <label for="jumlah_awal" class="col-sm-3 col-form-label">Jumlah Awal</label>
                                        <div class="col-sm-8 ml-3">
                                        <input type="number" class="form-control" value="<?= $p->jumlah_awal; ?>" name="jumlah_awal" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="jumlah_akhir" class="col-sm-3 col-form-label">Jumlah Mati</label>
...
<?php foreach($pembibitan as $p) : ?>
            <div class="modal fade" id="hapusbibitModal<?= $p->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="ml-3">Tanggal  : <?= $p->tanggal; ?> ?</div>
                        <div class="modal-footer">
                            <button class="btn btn-secondary" type="button" data-dismiss="modal">Tidak</button>
                            <a class="btn btn-danger" href="/pembibitanAdmin/hapus/<?= $p->id; ?>">Hapus</a>
                        </div>
                    </div>
                </div>
            </div>
